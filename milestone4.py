# ReviewSense
# Milestone 4 (Enhanced & Fixed Final)
...
def load_keywords():
    try:
        ...
        # Silent fail to keep dashboard running if file is missing
        return pd.DataFrame()
